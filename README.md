...
1. RMSE results after running with Dataset 1 can be found below:

Input: Dataset-1 in Simulator

Process: ./ExtendedKF ../data/sample-laser-radar-measurement-data-1.txt ../data/output-1.txt
...
2. RMSE results after running with "Dataset 2" can be found below:

Input: Dataset-2 in Simulator
